...
public class InfoHudViewHolder {
    ...
    public InfoHudViewHolder(Context context, TableLayout tableLayout,VideoPlayListener listener) {
    ...
    private static String formatPosition(long position){
        ...
        seconds-=minute*60;
        return String.format(Locale.US, "%d:%d:%d", hour,minute,seconds);
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_UPDATE_HUD: {
                    ...
                    setRowValue(R.string.current_position, String.format(Locale.US, "%s", formatPosition(current)));
